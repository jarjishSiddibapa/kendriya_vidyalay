...
public class Printer {
    ...
    public static void printTable(ResultSet resultSet) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            for (int columnIndex = 1; columnIndex <= columnCount; columnIndex++) {
                ...
                columnWidths[columnIndex - 1] = Math.max(columnWidths[columnIndex - 1], rowData[columnIndex - 1].length());
            }
            allRows.add(rowData);
        }
    ...
    /**
     * Prints a list of Java objects (beans/POJOs) as a formatted table using reflection.
     */
